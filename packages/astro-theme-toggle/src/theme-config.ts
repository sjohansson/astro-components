...
export function generateThemeCSS(theme: ThemeConfig): string {
  ...
  // Interactive colors
  cssVars.push(
    `  --theme-interactive-default: ${theme.colors.interactive.default};`,
  );
  cssVars.push(
    `  --theme-interactive-hover: ${theme.colors.interactive.hover};`,
  );
  cssVars.push(
    `  --theme-interactive-active: ${theme.colors.interactive.active};`,
  );
  cssVars.push(
    `  --theme-interactive-disabled: ${theme.colors.interactive.disabled};`,
  );
